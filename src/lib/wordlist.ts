export const PASSPHRASE_WORDS: string[] = [
  ...
  "age", "agency", "agent", "ago", "agree", "ahead", "air", "all", "allow", "almost",
  ...
  "beat", "beautiful", "because", "become", "bed", "been", "before", "begin", "behavior", "behind",
  ...
  "news", "newspaper", "next", "nice", "night", "no", "none", "nor", "north", "not",
  "note", "nothing", "notice", "now", "number", "occur", "of", "off", "offer", "office",
  ...
  "play", "player", "please", "pm", "point", "police", "policy", "political", "politics", "poor",
  ...
  "senior", "sense", "sentence", "separate", "series", "serious", "serve", "service", "set", "seven",
  ...
  "will", "win", "wind", "window", "wish", "with", "woman", "wonder", "word", "work",
  "worker", "world", "worry", "would", "write", "writer", "wrong", "yard", "yeah", "year",
  "yes", "yet", "you", "young", "your", "yourself", "zebra", "zero", "zone", "zoom"
];

if (import.meta.env.DEV && new Set(PASSPHRASE_WORDS).size < 2048) {
  console.error("PassGuard: passphrase wordlist is too small");
}